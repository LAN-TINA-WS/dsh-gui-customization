...
export const PRESET_ORDER = ['default', 'nous', 'indigo', 'emerald', 'sunset']
export const PRESET_LABELS: Record<string, string> = { default: '系统默认', nous: 'Nous 蓝', indigo: '靛紫', emerald: '翡翠绿', sunset: '暖阳橙' }
